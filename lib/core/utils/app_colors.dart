...
abstract class AppColors {
  static const Color teal = Color(0xff24AC98);
  static const Color pink = Color(0xff62469A);
  static const Color blue2 = Color(0xff407BFF);
  static const Color blueLight = Color(0xff90AAE5);
